...
class Outline extends Model2
{
	public $__table = 'outlines';

	static public function __schema()
	{
		return [
			'outline_id' => self::field()->primary(),
	...
	public function name_exists($name, $exclude_outline_id = 0)
	{
		$query = $this->db	->from('outlines')
							->where('name', $name);

		if ($exclude_outline_id)
		{
			$query->where('outline_id <>', (int)$exclude_outline_id);
		}
