...
class Admin_Ajax extends Controller_Module
{
	public function index($action, $title, $icon, $module_name, $id)
	{
		...
		return $this->col(
			$this	->panel()
					->heading('<span class="float-right">'.$this->button()->tooltip($this->lang('Utilisateurs'))->icon('fas fa-users')->color('info access-users')->class('hb-btn-sm hb-btn-outline').'</span>'.$title, $icon)
