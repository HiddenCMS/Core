<div class="user-profile">
	...
	<?php if ($this->user() && $this->user != $user) echo $this->button()->title('Contacter')->icon('far fa-envelope')->color('dark')->style('hb-btn-block')->url('user/messages/compose/'.$user->url()) ?>
</div>
