...
class Index extends Controller_Module
{
	...
	{
		return $this->array()
					->append($this->panel()->body('<h2 class="m-0">'.$this->lang('Group').' <small>'.$title.'</small>'.$this->button()->tooltip($this->lang('See all members'))->icon('fas fa-times')->url('members')->color('danger float-right')->compact()->outline().'</h2>')->style('mb-4'))
