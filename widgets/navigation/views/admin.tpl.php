...
<div class="tab-content border-light" id="pills-tabContent">
	<div class="tab-pane fade show active" id="pills-options" role="tabpanel" aria-labelledby="pills-options-tab">
		<div class="fields">
			<label for="settings-menu-id" class="four wide field"><?php echo $this->lang('Menu') ?></label>
		...
		<div class="fields">
			<label for="settings-panel" class="four wide field"><?php echo $this->lang('Panneau') ?></label>
			<div class="eight wide field">
