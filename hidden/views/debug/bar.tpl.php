<div class="debug-bar hidden-xs<?php if ($active) echo ' active' ?>">
	...
	<nav>
		...
		<div class="float-right">
			...
			<p><?php echo icon('far fa-clock').' '.round((microtime(TRUE) - HIDDEN_TIME) * 1000, 2).' ms' ?></p>
			<p><?php echo icon('fas fa-cogs').' '.ceil((memory_get_peak_usage() - HIDDEN_MEMORY) / 1024).' kB' ?></p>
